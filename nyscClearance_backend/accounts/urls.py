...
from .views import (
    ...
    GoogleMapsGeocodeView,
    GoogleMapsReverseGeocodeView,
    LoginView,
    LogoutView,
    MeView,
    ProfileView,
...
urlpatterns = [
    ...
    path('clearance/verify/', verify_clearance, name='clearance-verify'),
    path('maps/config/', GoogleMapsConfigView.as_view(), name='google-maps-config'),
    path('maps/geocode/', GoogleMapsGeocodeView.as_view(), name='google-maps-geocode'),
    path('maps/reverse/', GoogleMapsReverseGeocodeView.as_view(), name='google-maps-reverse'),
