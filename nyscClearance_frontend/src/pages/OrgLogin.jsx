...
export default function OrgLogin(){
  ...
  const submit = async (e) => {
    ...
    try{ await ensureCsrf(); await api.post('/api/auth/login/', { ...form, role:'ORG' }); navigate('/dashboard/org') }catch(err){ setStatus('error:'+(err?.response?.data?.detail||'Login failed')) }
  }
  return (
    <div className="row justify-content-center">
      <div className="col-md-6 col-lg-5">
        <div className="card shadow-sm"><div className="card-body p-4">
          <h1 className="h4 mb-3 text-olive">Organization Login</h1>
